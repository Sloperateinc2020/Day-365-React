    ...
    <>
      <div style={styles.container}>
        <div style={styles.header}>
          <img src="/service.jpg" alt="Urban Mavrick" style={styles.headerImage} />
          <div style={styles.headerText}>
            <h1 style={styles.headerTitle}>Urban Mavrick?</h1>
            <p style={styles.headerDescription}>
            Urban Mavrick is a trusted platform for people to receive local services.
            Urban Mavrick is the best choice for low-cost quality professional services.
            </p>
          </div>
        </div>

        <section style={styles.whyChoose}>
          <h2 style={styles.sectionTitle}>Why choose Urban Mavrick?</h2>
              ...
              <>
                <div style={styles.featuresRow}>
                  <div style={styles.feature}>
                    ...
                    Urban Mavrick  is your 24/7 personal assistant providing you with convenient services.
                    </p>
                  </div>
                  <div style={styles.feature}>
                    <h3 style={styles.featureTitle}>Reliable</h3>
                    <p style={styles.featureText}>
                      All Urban Mavrick service providers are professionals who have been background-checked and reviewed by other customers.
                    </p>
                  </div>
                </div>
                <div style={styles.featuresRow}>
                  <div style={styles.feature}>
                    ...
                    <p style={styles.featureText}>
                    Urban Mavrick offers a transparent pricing system that allows you to see the cost of the service before you book.
                    </p>
                  </div>
                  <div style={styles.feature}>
                    <h3 style={styles.featureTitle}>Professional</h3>
                    <p style={styles.featureText}>
                    Urban Mavrick provides a wide range of services, including cleaning, moving, delivery, and more, to meet all your needs.
                    </p>
                  </div>
                </div>
              </>
